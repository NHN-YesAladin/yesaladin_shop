...
## Test Coverage
- 목표 : 라인 커버리지 80% 이상 (2023.02.27 기준 87.11%)  
  ![스크린샷 2023-02-27 오전 1 13 45](https://user-images.githubusercontent.com/60968342/221422364-80d5be9c-cdb8-4b4d-ab6a-84b840b6546d.png)
...
- **매출 통계 및 베스트셀러**
  - 정해진 기간의 매출 통계 조회
  - 1년 기준 베스트셀러 12개 조회
- **장바구니 담기/삭제, 수량 수정, 주문 후 장바구니  상품 삭제**
...
- **검색**
  - 메인 상품 검색
    ...
    - 메인 상품 등록을 위한 태그, 카테고리, 출판사, 저자 검색
  - 회원
    - 관리자가 회원 차단/삭제 관리 검색(DB)
- **위시리스트**
  - 위시리스트 등록/삭제
  - 위시리스트 페이지 조회
- **최근 본 상품**
